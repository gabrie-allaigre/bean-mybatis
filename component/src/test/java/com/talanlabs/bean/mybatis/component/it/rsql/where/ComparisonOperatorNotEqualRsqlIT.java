...
public class ComparisonOperatorNotEqualRsqlIT {
    ...
    public void testStartStringRsql() {
        ...
        Assertions.assertThat(res).isNotNull();
        Assertions.assertThat(res.joins).isEmpty();
        Assertions.assertThat(res.wheres).containsOnly("FIRST_NAME not like #{0,javaType=java.lang.String} || '%' ESCAPE '\\'");
        Assertions.assertThat(res.parameterMap).containsEntry("0", "FRA");
    }
    ...
    public void testContains2StringRsql() {
        ...
        Assertions.assertThat(res).isNotNull();
        Assertions.assertThat(res.joins).isEmpty();
        Assertions.assertThat(res.wheres).containsOnly("FIRST_NAME not like '%' || #{0,javaType=java.lang.String} || '%' || #{1,javaType=java.lang.String} || '%' ESCAPE '\\'");
    ...
    public void testContainsDoubleRsql() {
        ...
        Assertions.assertThat(res).isNotNull();
        Assertions.assertThat(res.wheres).containsOnly("WEIGHT not like #{0,javaType=java.lang.String} || '%' ESCAPE '\\'");
    ...
    public void testContainsEnumRsql() {
        ...
        Assertions.assertThat(res).isNotNull();
        Assertions.assertThat(res.wheres).containsOnly("SEXE not like '%' || #{0,javaType=java.lang.String} ESCAPE '\\'");
