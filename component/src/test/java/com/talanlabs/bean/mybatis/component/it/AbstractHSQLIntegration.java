...
import com.talanlabs.bean.mybatis.component.factory.ComponentObjectFactory;
import com.talanlabs.bean.mybatis.component.factory.ComponentProxyFactory;
import com.talanlabs.bean.mybatis.component.it.config.DefaultNlsColumnHandler;
import com.talanlabs.bean.mybatis.component.it.config.DefaultUserByHandler;
import com.talanlabs.bean.mybatis.component.it.mapper.NlsMapper;
...
public abstract class AbstractHSQLIntegration {
    ...
    public static void beforeClass() {
        ...
        if (defaultNlsColumnHandler == null) {
        ...
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(AbstractHSQLIntegration.beanConfiguration);
