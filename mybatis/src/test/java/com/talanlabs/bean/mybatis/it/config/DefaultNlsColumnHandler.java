package com.talanlabs.bean.mybatis.it.config;
...
public class DefaultNlsColumnHandler implements INlsColumnHandler {
    ...
    @Override
    public Map<String, Object> getAdditionalParameter(Class<?> beanClass, String propertyName) {
    ...
    @Override
    public String getSelectNlsColumnId(Class<?> beanClass, String propertyName) {
        return "com.talanlabs.bean.mybatis.it.mapper.NlsMapper.selectNlsColumn";
    }

    @Override
    public boolean isUpdateDefaultNlsColumn(Class<?> beanClass, String propertyName) {
        return "eng".equals(languageCode);
    }

    @Override
    public String getMergeNlsColumnId(Class<?> beanClass, String propertyName) {
        return "com.talanlabs.bean.mybatis.it.mapper.NlsMapper.mergeNlsColumn";
    }

    @Override
    public String getDeleteNlsColumnsId(Class<?> beanClass) {
        return "com.talanlabs.bean.mybatis.it.mapper.NlsMapper.deleteNlsColumns";
    }
    ...
    public Pair<String, SqlResult> buildNameResultForWhere(Class<?> beanClass, String propertyName, String previousPropertyName, String tableJoinName, SqlContext context) {
        ...
        if (StringUtils.isBlank(joinTableName)) {
            ...
            Column idColumn = metaInfoBean.getPropertyAnnotation(idPpropertyName, Column.class);
