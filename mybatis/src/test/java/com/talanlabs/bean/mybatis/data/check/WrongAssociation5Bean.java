...
public class WrongAssociation5Bean extends EntityBean {

    @Column(name = "START_COUNTRY_ID")
    private IId startCountryId;
    @Association(propertySource = "startCountryId", propertyTarget = { "code", "id" }, joinTable = @JoinTable(name = "t_asso", left = "id", right = "one"))
